...
Current module/root coverage: **8 named tests** (scenario groups
...
| --- | --- |
| empty_becomes_absent | src/shared/env/env.spec.ts > V01 presence |
| manifest_discloses | src/root/foundations.spec.ts > F02/F03 output choices preserve workflow and scope relations, src/shared/env/env.spec.ts > V05 manifest |
| false_becomes_true | src/shared/env/env.spec.ts > V02 parsers |
